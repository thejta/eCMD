...
my @ignores = qw( ecmdLoadDll ecmdUnloadDll ecmdCommandArgs ecmdSetup ecmdDisplayDllInfo InitExtension cmdRunCommand ecmdFunctionTimer ecmdQueryScomGroup getScomGroup ecmdRunSoWithArgs);
