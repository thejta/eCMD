...
doxygen-capi: ecmdcapi ${EXT_CAPI_TARGETS}
	...
	${VERBOSE}$(shell sed "s!ECMDVERSION!${ECMD_VERSION}!g" ${ECMD_ROOT}/docs/ecmdDoxygen.config | sed "s!INPUTOUTPUT_PATH!${DOXYGEN_CAPI_PATH}!g" > ${DOXYGEN_CAPI_PATH}/ecmdDoxygen.config)
	...
	${VERBOSE}cd ${DOXYGEN_CAPI_PATH}; ${DOXYGEN} ecmdDoxygen.config
...
doxygen-perlapi: ecmdcapi ${EXT_PERLAPI_TARGETS} ecmdperlapi
	...
	${VERBOSE}$(shell sed "s!ECMDVERSION!${ECMD_VERSION}!g" ${ECMD_ROOT}/docs/ecmdDoxygenPm.config | sed "s!INPUTOUTPUT_PATH!${DOXYGEN_PERLAPI_PATH}!g" > ${DOXYGEN_PERLAPI_PATH}/ecmdDoxygenPm.config)
	...
	${VERBOSE}cd ${DOXYGEN_PERLAPI_PATH}; ${DOXYGEN} ecmdDoxygenPm.config
...
doxygen-pyapi: ecmdcapi ${EXT_PYAPI_TARGETS} ecmdpyapi
	...
	${VERBOSE}$(shell sed "s!ECMDVERSION!${ECMD_VERSION}!g" ${ECMD_ROOT}/docs/ecmdDoxygenPython.config | sed "s!INPUTOUTPUT_PATH!${DOXYGEN_PYAPI_PATH}!g" > ${DOXYGEN_PYAPI_PATH}/ecmdDoxygenPython.config)
	...
	${VERBOSE}cd ${DOXYGEN_PYAPI_PATH}; ${DOXYGEN} ecmdDoxygenPython.config
