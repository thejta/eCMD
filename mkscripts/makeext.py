...
if (sys.argv[1] == "cmd"):
  ...
  extfile = open(os.environ["ECMD_ROOT"] + "/ecmd-core/cmd/ecmdExtInterpreter.C", 'w')
...
if (sys.argv[1] == "pyapi"):
  ...
  # Open our file and start writing
  extfile = open(os.environ["ECMD_ROOT"] + "/ecmd-core/pyapi/ecmdExtIncludes.i", 'w')
  ...
  # Open our file and start writing
  extfile = open(os.environ["ECMD_ROOT"] + "/ecmd-core/pyapi/ecmdExtInserts.i", 'w')
...
if (sys.argv[1] == "perlapi"):
  ...
  # Open our file and start writing
  extfile = open(os.environ["ECMD_ROOT"] + "/ecmd-core/perlapi/ecmdExtIncludes.i", 'w')
  ...
  # Open our file and start writing
  extfile = open(os.environ["ECMD_ROOT"] + "/ecmd-core/perlapi/ecmdExtInserts.i", 'w')
