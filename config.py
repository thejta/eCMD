...
# Those variables are then written out to a makefile.config included by the build
...
print("")
print("# These variables are generated by config.py")
print("")
