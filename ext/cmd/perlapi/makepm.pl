...
if (-e "$curdir/$ARGV[0]ClientPerlapi.i") {
  ...
  print RENAMEOUT "// Autogenerated by makepm.pl based upon the \"%template\"'s defined\n";
  print HEADEROUT "// Autogenerated by makepm.pl based upon the \"%template\"'s defined\n";
  print PERLOUT   "#  Autogenerated by makepm.pl based upon the \"%template\"'s defined\n";
